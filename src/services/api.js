...
const API_URL = 'https://tienda-backend-au3t.onrender.com/api/seller';
...
export const sellerLogin = async (loginData) => {
  try {
    const response = await axios.post('https://tienda-backend-au3t.onrender.com/api/seller/login', loginData, {
      headers: {
